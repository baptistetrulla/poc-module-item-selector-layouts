...
<%
LayoutItemSelectorViewDisplayContext layoutItemSelectorViewDisplayContext = (LayoutItemSelectorViewDisplayContext)request.getAttribute("LAYOUT_ITEM_SELECTOR_VIEW_DISPLAY_CONTEXT");
...
System.out.println("view.jsp from poc-module-item-selector-layouts");
%>
